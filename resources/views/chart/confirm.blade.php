            ...
            <div class="container mt-5">
                <form action="{{ action('ChartController@create') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-md-6 chart-question">お名前（漢字）</label>
                        <p class="col-md-6">{{ $inputs['name01'] }}</p>
                        <div class="col-md-10">
                            <input type="hidden" class="form-control" name="name01" value="{{ $inputs['name01'] }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-6 chart-question">お名前（ふりがな）</label>
                        <p class="col-md-6">{{ $inputs['name02'] }}</p>
                        <div class="col-md-10">
                            <input type="hidden" class="form-control" name="name02" value="{{ $inputs['name02'] }}">
                        </div>
                    </div>
                    <div class="form-group row ">
                        <label class="col-md-6 chart-question">お電話番号</label>
                    ...
                    <div class="form-group row ">
                        <label class="col-md-6 chart-question">メールアドレス</label>
                    ...
                    <div class="form-group row ">
                        <label class="col-md-6 chart-question">生年月日</label>
                        <p class="col-md-6">{{ $inputs['birthday'] }}</p>
                        <div class="col-md-10">
                            <input type="hidden" class="form-control" name="birthday" value="{{ $inputs['birthday'] }}">
                        </div>
                    </div>
                    <div class="form-group row ">
                        <label for="inputAddress01" class="col-md-6 chart-question">郵便番号(7桁)</label>
                        <p class="col-md-6">{{ $inputs['zip'] }}</p>
                        <div class="col-md-10">
                    ...
                    <div class="form-group row ">
                        <label for="inputAddress02"class="col-md-6 chart-question">都道府県</label>
                        <p class="col-md-6">{{ $inputs['pref'] }}</p>
                        <div class="col-md-10">
                            <input type="hidden" name="pref" id="inputAddress02" class="form-control" value="{{ $inputs['pref'] }}" >
                        </div>
                    </div>
                    <div class="form-group row ">
                        <label for="inputAddress03" class="col-md-6 chart-question">市区町村・番地</label>
                        <p class="col-md-6">{{ $inputs['addr01'] }}</p>
                        <div class="col-md-10">
                            <input type="hidden" name="addr01" class="form-control" id="inputAddress03"  value="{{ $inputs['addr01'] }}" >
                        </div>
                    </div>
                    <div class="form-group row ">
                        <label for="inputAddress03" class="col-md-6 chart-question">建物名・その他</label>
                        <p class="col-md-6">{{ $inputs['addr02'] }}</p>
                        <div class="col-md-10">
                            <input type="hidden" name="addr02" class="form-control" id="inputAddress04" value="{{ $inputs['addr02'] }}" >
                        </div>
                    </div>
                    <div class="form-group row ">
                        <label class="col-md-12 chart-question">ご来店きっかけ</label>
                        <p class="col-md-12">
                    ...
                    <div class="form-group row ">
                        <label class="col-md-6 chart-question">施術トラブルのご経験</label>
                        <p class="col-md-6">{{ $inputs['trouble'] }}</p>
                        <div class="col-md-10">
                            <input type="hidden" class="form-control"  name="trouble"  value="{{ $inputs['trouble'] }}">
                        </div>
                    </div>
                    <div class="form-group row ">
                        <label class="col-md-6 chart-question">お目元・眉周りのお悩み</label>
                        <p class="col-md-6">{{ $inputs['concern'] }}</p>
                        <div class="col-md-10">
                            <input type="hidden" class="form-control"  name="concern"  value="{{ $inputs['concern'] }}">
                        </div>
                    </div>
                     <div class="form-group row ">
                        <label class="col-md-6 chart-question">アレルギー</label>
                        <p class="col-md-6">{{ $inputs['allergy'] }}</p>
                        <div class="col-md-10">
                            <input type="hidden" class="form-control"  name="allergy"  value="{{ $inputs['allergy'] }}">
                        </div>
                    </div>
                    <div class="form-group row ">
                        <label class="col-md-6 chart-question">過去の施術経験</label>
                        <p class="col-md-6">{{ $inputs['record'] }}</p>
                        <div class="col-md-10">
                            <input type="hidden" class="form-control"  name="record"  value="{{ $inputs['record'] }}">
                        </div>
                    </div>
                    <div class="form-group row ">
                        <label class="col-md-6 chart-question">気になる身体の疲れ</label>
                        <p class="col-md-6">{{ $inputs['body_concern'] }}</p>
                        <div class="col-md-10">
