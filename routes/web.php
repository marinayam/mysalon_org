...
// おすすめメニュー診断
Route::get('/match', function(){ return view('salon.match.match'); })->name('match'); // 質問：自まつ毛が多い
Route::get('/match2', function(){ return view('salon.match.match2'); })->name('match2');  // 質問：まつ毛が下がっている
Route::get('/match3', function(){ return view('salon.match.match3'); })->name('match3');  // 質問：汗をかきやすい
Route::get('/match4', function(){ return view('salon.match.match4'); })->name('match4');  // 4択問題
...
// おすすめメニュー診断
Route::get('/staff', 'SalonController@index')->name('staff'); // スタッフ紹介
// お問い合わせフォーム
...
Route::group(['prefix' => 'admin'], function(){
  // 管理者画面
   ...
   // 最初のページ
    ...
    Route::get('salon/index', 'Admin\UserController@index');
    Route::get('salon/index', 'Admin\UserController@chart');
    // Route::get('salon/index', 'Admin\UserController@appointment');
    // カルテ顧客情報
